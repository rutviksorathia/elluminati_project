                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                        model.autogenerated!.specifications
                                            .first.name.first,
                                        style: const TextStyle(
                                          fontSize: 16,
                                    ...
                                    children: [
                                      if (model.autogenerated != null)
                                        ...model.autogenerated!.specifications
                                            .first.list
                                            .map((list) {
                                          int index = model.autogenerated!
                                              .specifications.first.list
                                              .indexOf(list);
